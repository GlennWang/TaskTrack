...
# 設置資料庫連線
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database/tasktrack.db'
...
# 註冊todo_list_view
app.add_url_rule('/todo_lists/', defaults={'item_id': None},
                 view_func=todo_list_view, methods=['GET', ])
app.add_url_rule('/todo_lists/',
                 view_func=todo_list_view, methods=['POST'])
app.add_url_rule('/todo_lists/<int:item_id>', view_func=todo_list_view, methods=['GET', 'PUT', 'DELETE'])
